          ...
          <div class="collapse navbar-collapse" id="navb">
            <ul class="navbar-nav mr-auto">
              <li class="nav-item mr-3">
                <a href="index.html" class="nav-link text-white fs-20"><i class="fas fa-home"></i> Home</a>
              </li>
              <li class="nav-item mr-3">
                <a href="list.html" class="nav-link text-white fs-20">Nguyên căn</a>
              </li>
              <li class="nav-item mr-3">
                <a href="list.html" class="nav-link text-white fs-20">Ở ghép</a>
              </li>
              <li class="nav-item mr-3">
                <a href="list.html" class="nav-link text-white fs-20">Phòng trọ</a>
              </li>
              <li class="nav-item mr-3">
        ...
        <div class="row">
            ...
            <div class="p-4">
              <div class="row d-table">
                <div class="col-md-5 d-table-cell align-middle">
                  <img class="w-100" src="../img/cat-1.svg">
                </div>
          ...
          <div class="col">
            <div class="p-4">
              <div class="row d-table">
                <div class="col-md-5 d-table-cell align-middle">
                  <img class="w-100" src="../img/cat-2.svg">
                </div>
                <div class="col-md-7 d-table-cell align-middle">
                  <h4>Ở ghép</h4>
                  <p>4,000 tin mua bán</p>
          ...
          <div class="col">
            <div class="p-4">
              <div class="row d-table">
                <div class="col-md-5 d-table-cell align-middle">
                  <img class="w-100" src="../img/cat-3.svg">
                </div>
                <div class="col-md-7 d-table-cell align-middle">
                  <h4>Phòng trọ</h4>
                  <p>4,000 tin mua bán</p>
